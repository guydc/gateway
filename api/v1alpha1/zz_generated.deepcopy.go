...
func (in *ExtProc) DeepCopyInto(out *ExtProc) {
	*out = *in
	if in.BackendRefs != nil {
		...
		*out = make([]ExtProcBackendRef, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtProcAttributes.
func (in *ExtProcAttributes) DeepCopy() *ExtProcAttributes {
	if in == nil {
		return nil
	}
	out := new(ExtProcAttributes)
