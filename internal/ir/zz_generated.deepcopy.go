...
func (in *DestinationSetting) DeepCopyInto(out *DestinationSetting) {
	*out = *in
	if in.DynamicResolverAddressFilter != nil {
		in, out := &in.DynamicResolverAddressFilter, &out.DynamicResolverAddressFilter
		*out = new(DynamicResolverAddressFilter)
		(*in).DeepCopyInto(*out)
	}
	if in.Weight != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DynamicResolverAddressFilter) DeepCopyInto(out *DynamicResolverAddressFilter) {
	*out = *in
	if in.CIDRMatches != nil {
		in, out := &in.CIDRMatches, &out.CIDRMatches
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DynamicResolverAddressFilter.
func (in *DynamicResolverAddressFilter) DeepCopy() *DynamicResolverAddressFilter {
	if in == nil {
		return nil
	}
	out := new(DynamicResolverAddressFilter)
